...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">Online Food</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
...
<div class="container-fluid">
  <div class="row">
	...
	<div class="container-fluid">
	 ...
	 <div class="container">
	 <p style="font-family: 'Lobster', cursive; font-weight:light;  font-size:25px;">Great Food structure and cleanliness.</p>
	 </div>
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	   ...
	   <div class="col-sm-6">
	        <div class="container-fluid">
	             <img src="img/pastaveg_640x480.jpg" height="200px" width="50%"><!--image-->
	        </div>
	        <div class="container">
	        <!--paragraph content--> 
	             <p style="font-family: 'Lobster', cursive; font-weight:light; font-size:25px;">Extreme predetermined food content.</p>
	        </div>
	  </div>
